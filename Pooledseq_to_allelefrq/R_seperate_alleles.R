...
# Having to type out each of these file names is kind of asking for errors from typos
# or other things. I think we could make this more efficient by using something like
# the suggestion below:
# PoolFiles <- list.files(path = <directory with all files>)
# If there are extra files, they could be removed manually or with setdiff()
# pool_names <- c("Chromosome", "Location", "Ref", PoolFiles)
