...
Format_allele_frqs_ancestral.R 
combine_newgerp.R
...
starting files "Allele_frequencies.delim" and "All_ANC.delim"
run Rscript Format_allele_frqs_ancestral.R
...
starting files "Full_data_newgerp.delim" and oupult file from Ensembl VEP
run Rscript Variant_effects.R
This will take the amino acid changes identified by Ensembl VEP for each lactation in the genome and create a grantham score for it
...
Starting files "Beetle_fitness_filtered.delim"and "Grantham_GERP_derived.delim"
